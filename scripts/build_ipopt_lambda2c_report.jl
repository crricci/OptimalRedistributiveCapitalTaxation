...
function main()
    ...
    summary_csv = joinpath(outputs_dir, "ipopt_lambda2c_grid_beta075_summary.csv")
    ...
    report_lines = String[]
    push!(report_lines, "# Ipopt Lambda2-c Grid Report")
    push!(report_lines, "")
    push!(report_lines, "| T | N | success | residual | status | final_k | final_q | tvc_k | lambda2c | tvc_q | plot |")
    push!(report_lines, "| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |")
    for row in rows
    ...
    report_path = joinpath(outputs_dir, "ipopt_lambda2c_grid_report.md")
